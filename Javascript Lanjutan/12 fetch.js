...
searchButton.addEventListener('click', function() {
    ...
    fetch('http://www.omdbapi.com/?apikey=46c8a735&s=' + inputKeyword.value)
    .then(response => response.json()).then(response => {
        const movies = response.Search; let cards = '';
        ...
        modalDetailButton.forEach( btn => {
            btn.addEventListener('click', function(){
                ...
                fetch('http://www.omdbapi.com/?apikey=46c8a735&i=' + imdbid)
